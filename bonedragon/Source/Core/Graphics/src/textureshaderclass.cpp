...
bool TextureShaderClass::InitializeShader(ID3D10Device* device, HWND hwnd, WCHAR* filename)
{
	...
	//Get the description of the first pass bescribed in the shader technique
	...
	// Get point to the texture resource inside the shader
...
void TextureShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	...
	// Open a file to write the rror message to
	fout.open("shader-error.txt");
	//Write out the rror message
	...
	MessageBox(hwnd, L"Error compiling shader. Check shader-error.txt for the error message.", shaderFilename, MB_OK);
