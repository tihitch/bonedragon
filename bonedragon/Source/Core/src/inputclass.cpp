...
void InputClass::ProcessInput()
{
	...
	if(m_mouseX > m_screenWidth-INPUT_BORDER_RIGH) {m_mouseX = m_screenWidth-INPUT_BORDER_RIGH;}
...
bool InputClass::IsPeriodPressed()
{
...
bool InputClass::IsCommaPressed()
{
...
bool InputClass::IsSpaceReleased()
{
	bool down = IsSpacePressed();
	if(down){
		m_spaceDown = true;
		return false;
	}
